...
Construimos solo el v1, empezando por el worker de Python. Antes de escribir código, propón la estructura del repositorio y confírmala conmigo. El stack ya está decidido, no lo cambies. Si te encuentras con una decisión que no está en este documento, pregúntame en vez de asumir.
...
| Campo | Tipo | Notas |
|-------|------|-------|
| `publisher_id` | bigint GENERATED BY DEFAULT AS IDENTITY PK | secuencial (1, 2, 3…); Postgres lo asigna automáticamente |
